...
export default {
	...
	plugins: [
		// Plugin to generate v-* utilities from CSS variables
		function ({ addUtilities }) {
			const vUtilities = {
				// VNext Design Token Utilities
				// Background colors
				'.bg-v-bg': { backgroundColor: 'var(--surface-bg-default)' },
				'.bg-v-bg-elevated': { backgroundColor: 'var(--surface-bg-elevated)' },
				'.bg-v-surface': { backgroundColor: 'var(--surface-surface-default)' },
				'.bg-v-surface-hover': { backgroundColor: 'var(--surface-surface-hover)' },
				'.bg-v-primary': { backgroundColor: 'var(--interactive-primary-default)' },

				// Text colors
				'.text-v-primary': { color: 'var(--text-primary)' },
				'.text-v-secondary': { color: 'var(--text-secondary)' },
				'.text-v-tertiary': { color: 'var(--text-tertiary)' },
				'.text-v-accent': { color: 'var(--text-accent)' },

				// Border colors
				'.border-v-border': { borderColor: 'var(--surface-border-default)' },
				'.border-v-border-subtle': { borderColor: 'var(--surface-border-subtle)' },
				'.border-v-border-accent': { borderColor: 'var(--surface-border-accent)' },

				// Shadows
				'.shadow-v-card': { boxShadow: 'var(--shadow-card)' },
				'.shadow-v-card-hover': { boxShadow: 'var(--shadow-card-hover)' },

				// Border radius
				'.rounded-v-sm': { borderRadius: 'var(--radius-sm)' },
				'.rounded-v-base': { borderRadius: 'var(--radius-base)' },
				'.rounded-v-md': { borderRadius: 'var(--radius-md)' },
				'.rounded-v-lg': { borderRadius: 'var(--radius-lg)' },
				'.rounded-v-xl': { borderRadius: 'var(--radius-xl)' },

				// Spacing utilities
				'.p-v-4': { padding: 'var(--space-4)' },
				'.p-v-6': { padding: 'var(--space-6)' },
				'.p-v-8': { padding: 'var(--space-8)' },
				'.gap-v-4': { gap: 'var(--space-4)' },
				'.gap-v-6': { gap: 'var(--space-6)' }
			};

			addUtilities(vUtilities);
		}
	]
};
